<header>
    <div class="container">
        <div class="row justify-content-center justify-content-lg-between align-items-center gy-4">
            ...
            <div class="col-auto">
                <div class="font-articulat text-white">More Options. <span class="fw-900 font-articulat-heavy">More You</span><span class="text-secondary">.</span></div>
            </div>
        </div>
    </div>
</header>
...
<section class="affiliate-partner">
    <div class="container">
        <div class="affiliate-partner-img">
            <?= renderImg('affiliate-partner.jpg', 'lib') ?>
            <button class="play-button"><?= renderImg('play-button.png', 'lib') ?></button>
        </div>
    </div>
</section>
...
<footer>
    <div class="container">
        ...
        <div class="text-light fs-11 py-4">
